...
class WechatHelper {
  ...
  _universalShare(friendConf, timelineConf) {
    ...
    this.wx.hideMenuItems({
      menuList: ['menuItem:share:qq', 'menuItem:share:weiboApp', 'menuItem:share:facebook', 'menuItem:share:QZone',  'menuItem:openWithSafari', 'menuItem:share:email']
    })
    this.wx.showMenuItems({
      menuList: ['menuItem:refresh', 'menuItem:share:appMessage', "menuItem:share:timeline", 'menuItem:copyUrl'] // 要隐藏的菜单项，所有menu项见附录3
    })
  }
