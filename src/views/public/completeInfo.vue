  ...
  methods: {
    ...
    inputHandler(event) {
      ...
      if (event && event.length > 0) {
        ...
        //     this.name = inputStr
        //   }, 1)
        this.$store.dispatch('getUserInfo', Object.assign({},this.userInfo, { name: this.name }))
      }
    },
    focusHandler(focus) {},
    blurHandler(focus) {},
    ...
    confirmHandler(val) {
      ...
      this.$store.dispatch('getUserInfo', Object.assign({},this.userInfo, { majorRegion: this.majorRegion }))
    },
    /**
     * 搜索公司
     */
    ...
    async updateUserInfo() {
      ...
      this.$store.dispatch('getUserInfo', Object.assign({},this.userInfo, params))
