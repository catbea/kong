    ...
    <div class="main_pages">
        <div class="pges_content">
            <div class="pages_tabs"> 
                <van-tabs v-model="active" color="#007AE6" :line-width="15" :swipe-threshold="6" sticky animated title-active-color="#007AE6">
...
export default {
    ...
    data () {
        return {
            ...
            finished: false,
            questionData:JSON.parse(localStorage.getItem('awMasterUserInfo')).labelList,
            answersData:[],
            loading: false,
        }
    },
