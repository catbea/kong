...
const state = {
  ...
  userInfo: JSON.parse(localStorage.getItem('awMasterUserInfo')) || ((process.env.VUE_APP_AW_ENV=='uat' || process.env.VUE_APP_AW_ENV=='prod' || location.href.indexOf('sit') > -1) ? {} : {
    ...
    leavingStatus: 0,
    token:
      'eyJhbGciOiJIUzUxMiJ9.eyJyYW5kb21LZXkiOiJyeWZ4NjEiLCJzdWIiOiJhZ2VudElkOnd3OGY2ODAxYmE1ZmQyYTExMjoxMDAxNDc0IiwiZXhwIjoxNTYxNTMxMzM3LCJpYXQiOjE1NjA5MjY1Mzd9.2DRRkRoMejh0rT3o-7Hoei3A5v_I5Ir9u0_e1pkbuqSuWobrPKlbeymvvzAIixDPzN4LW9xwu526FkA_gBdeJg',
    majorCity: '深圳市',
