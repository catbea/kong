...
const state = {
  ...
  userInfo: JSON.parse(localStorage.getItem('awMasterUserInfo')) || {
    ...
    leavingStatus: 0,
    token:
      'eyJhbGciOiJIUzUxMiJ9.eyJyYW5kb21LZXkiOiI5MDhpcDkiLCJzdWIiOiJhZ2VudElkOnd3OGY2ODAxYmE1ZmQyYTExMjo0MTkzIiwiZXhwIjoxNTUwNTQxOTAxLCJpYXQiOjE1NTA1NDE2MDF9.Uf-KqCX0GvTnEW_xXv9GVMD-9WxkN30OWafhrxv4mYIsZzSNfEwRGGn1gtCMGfyKGXOfCm2hC1vDfXgmBdyNHQ',
    majorCity: '深圳市',
