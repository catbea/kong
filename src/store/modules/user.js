...
const state = {
  ...
  userInfo: JSON.parse(localStorage.getItem('awMasterUserInfo')) || {
    ...
    token:
    'eyJhbGciOiJIUzUxMiJ9.eyJyYW5kb21LZXkiOiJ5c3lrZ3AiLCJzdWIiOiJhZ2VudElkOnd3OGY2ODAxYmE1ZmQyYTExMjoxMjgiLCJleHAiOjE1NDYyMjQ5MjUsImlhdCI6MTU0NTYyMDEyNX0.o1Esv_n0SKf1M7qiJbq8_M79hntSQQefiyxkwj_qDl79C1OqKJmEhSon8e_V7m3dYeL2js0omLRVecZh3kpZjg',
